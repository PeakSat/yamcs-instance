...
# Change also the ./gdrive argument if this is altered. 
path=../../backups
...
while : ; do
    ...
    # This is the gdrive upload commmand that mirrors the backups folder
    # to a specific Google Drive folder
    # (currently this is a folder in an account dedicated for backups: yamcs.backup.acubesat@gmail.com).
