...
while [ : ]; do
    ...
    # this is the gdrive upload commmand that mirrors the backups folder to a specific Google Drive folder (currently this is a folder in an accoubnt dedicated for backups yamcs.backup.acubesat@gmail.com).
